...
result = draw_boxes(img_names, detection_result, class_names, _MODEL_SIZE)

result_array = img_to_array(result)
save_img("result_img.jpg", result_array)

result_img = cv2.imread("result_img.jpg")
